package nl.tudelft.sem.tams.authentication.integration;

import static nl.tudelft.sem.tams.authentication.integration.utils.JsonUtil.deserialize;
import static nl.tudelft.sem.tams.authentication.integration.utils.JsonUtil.serialize;
...
import nl.tudelft.sem.tams.authentication.models.LoginRequestModel;
import nl.tudelft.sem.tams.authentication.models.LoginResponseModel;
import nl.tudelft.sem.tams.authentication.models.RegistrationRequestModel;
import nl.tudelft.sem.tams.authentication.repositories.UserRepository;
import nl.tudelft.sem.tams.authentication.security.TokenGenerator;
...
public class UsersTests {
    ...
    public void login_withValidUser_returnsToken() throws Exception {
        ...
        when(mockTokenGenerator.generateJwtToken(
            argThat(userDetails -> userDetails.getUsername().equals(testUser)))
